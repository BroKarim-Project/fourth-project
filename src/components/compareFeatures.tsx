...
function FigmaFeatures() {
  return (
    <>
      <div className="sm:py-10  w-full">
        <h1 className="text-black mb-4 font-semibold text-3xl">Hobby Features</h1>
          ...
          <table className=" rounded w-full sm:px-0 px-10 overflow-x-scroll">
            <thead>
              <tr className="flex text-left">
                ...
                <th scope="col" className="w-full sm:w-1/5 flex flex-col items-center justify-center border bg-white border-r-0 border-gray-300 font-normal">
                ...
                <th scope="col" className="w-full sm:w-1/5  flex flex-col items-center justify-center  border bg-white border-r-0 border-gray-300 font-normal">
                  <h2 className="md:text-lg text-base font-medium">Professional</h2>
                  <p>
                    <span className="text-lg font-bold  md:text-4xl dark:text-gray-50">19€</span>
                    <span className="font-medium dark:text-gray-400">/mo</span>
                  </p>
                </th>
                <th scope="col" className="w-full sm:w-1/5  flex flex-col items-center justify-center border bg-white  border-gray-300 font-normal">
                ...
                <th scope="col" className="w-full sm:w-1/5 p-2 flex flex-col items-center justify-center border bg-white  border-gray-300 font-normal">
...
function FigjamFeatures() {
  return (
    <>
      <div className="sm:py-10  w-full">
        <h1 className="text-black mb-4 font-semibold text-3xl">Maiac Feature</h1>
...
export { FigmaFeatures, FigjamFeatures };
